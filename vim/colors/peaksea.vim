...
if &background=='light' 
  ...
  if v:version >= 700
    ...
    hi CursorLine	guifg=NONE	guibg=NONE	gui=underline guibg=Grey15
  ...
  if v:version >= 700
    ...
    hi CursorLine	gui=underline guibg=Grey15
  endif
  ...
  if &t_Co==256
    ...
    if v:version >= 700
      ...
      hi CursorLine	ctermfg=NONE	ctermbg=NONE	cterm=underline guibg=Grey15
...
elseif &background=='dark' 
  ...
  if &t_Co==8 || &t_Co==16
    ...
    if v:version >= 700
      ...
      hi CursorLine	ctermfg=NONE	ctermbg=bg		cterm=underline guibg=Grey15
